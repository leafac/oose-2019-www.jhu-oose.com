...
<figcaption>
The functionalities are the same, but the interfaces are different (the method names are different). Remember that in Java each class definition is also defining an interface for that class.
</figcaption>
</figure>
